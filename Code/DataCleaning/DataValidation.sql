...
-- check rows
SELECT 'PURCHASING_PRODUCTVENDOR' AS table_name, 
  COUNT(*) AS row_count
FROM PURCHASING_PRODUCTVENDOR
UNION
SELECT 'PURCHASING_PRODUCTVENDOR_CLEANED', 
  COUNT(*)
FROM PURCHASING_PRODUCTVENDOR_CLEANED;

SELECT 'PURCHASING_VENDOR' AS table_name, 
  COUNT(*) AS row_count
FROM PURCHASING_VENDOR
UNION
SELECT 'PURCHASING_VENDOR_CLEANED', 
  COUNT(*)
FROM PURCHASING_VENDOR_CLEANED;

SELECT 'PURCHASING_PURCHASEORDERDETAIL' AS table_name, 
  COUNT(*) AS row_count
FROM PURCHASING_PURCHASEORDERDETAIL
UNION
SELECT 'PURCHASING_PURCHASEORDERDETAIL_CLEANED', 
  COUNT(*)
FROM PURCHASING_PURCHASEORDERDETAIL_CLEANED;

SELECT 'PURCHASING_PURCHASEORDERHEADER' AS table_name, 
  COUNT(*) AS row_count
FROM PURCHASING_PURCHASEORDERHEADER
UNION
SELECT 'PURCHASING_PURCHASEORDERHEADER_CLEANED', 
  COUNT(*)
FROM PURCHASING_PURCHASEORDERHEADER_CLEANED;
