-- call task to create aggregation
CREATE OR REPLACE TASK CREATE_AGGREGATION_TASK
    WAREHOUSE = TEAM3_WH    
    ...
    BEGIN
        ...
        -- Xue Cong
        -- Staging table to be able to copy data without the polciy
        CREATE OR REPLACE TABLE TEAM3_DB.TEAM3_SCHEMA.SALES_SALESTERRITORY_STAGING AS 
        SELECT * FROM TEAM3_DB.TEAM3_SCHEMA.SALES_SALESTERRITORY_CLEANED;
    END;

ALTER TASK CREATE_AGGREGATION_TASK RESUME;
