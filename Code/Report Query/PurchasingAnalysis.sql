...
FROM PURCHASING_PURCHASEORDERHEADER_CLEANED AS poh 
INNER JOIN PURCHASING_VENDOR_CLEANED AS v ON poh."VendorID" = v."BusinessEntityID"
...
FROM PURCHASING_PURCHASEORDERHEADER_CLEANED AS poh 
INNER JOIN PURCHASING_SHIPMETHOD_CLEANED AS sm ON poh."ShipMethodID" = sm."ShipMethodID" 
