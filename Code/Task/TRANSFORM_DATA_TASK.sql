...
CREATE OR REPLACE TASK TRANSFORM_DATA_TASK
    ...
    SYSTEM$STREAM_HAS_DATA('HUMAN_RESOURCESDEPARTMENT_STREAM') OR
    SYSTEM$STREAM_HAS_DATA('HUMAN_RESOURCESEMPLOYEE_STREAM') OR
    SYSTEM$STREAM_HAS_DATA('PERSON_ADDRESS_STREAM') OR
    SYSTEM$STREAM_HAS_DATA('PERSON_PERSON_STREAM') OR
    SYSTEM$STREAM_HAS_DATA('PERSON_STATEPROVINCE_STREAM') OR
    SYSTEM$STREAM_HAS_DATA('PRODUCTION_PRODUCT_STREAM') OR
    SYSTEM$STREAM_HAS_DATA('PRODUCTION_PRODUCTCATEGORY_STREAM') OR
    SYSTEM$STREAM_HAS_DATA('PRODUCTION_PRODUCTINVENTORY_STREAM') OR
    SYSTEM$STREAM_HAS_DATA('PRODUCTION_PRODUCTSUBCATEGORY_STREAM') OR
    SYSTEM$STREAM_HAS_DATA('PURCHASING_PRODUCTVENDOR_STREAM') OR
    SYSTEM$STREAM_HAS_DATA('PURCHASING_PURCHASEORDERDETAIL_STREAM') OR
    SYSTEM$STREAM_HAS_DATA('PURCHASING_PURCHASEORDERHEADER_STREAM') OR
    SYSTEM$STREAM_HAS_DATA('SALES_CREDITCARD_STREAM') OR
    SYSTEM$STREAM_HAS_DATA('SALES_CURRENCY_STREAM') OR
    SYSTEM$STREAM_HAS_DATA('SALES_CURRENCYRATE_STREAM') OR
    SYSTEM$STREAM_HAS_DATA('SALES_SALESORDERHEADER_STREAM') OR
    SYSTEM$STREAM_HAS_DATA('SALES_SALESPERSON_STREAM') OR
    SYSTEM$STREAM_HAS_DATA('SALES_SALESPERSONQUOTAHISTORY_STREAM') OR
    SYSTEM$STREAM_HAS_DATA('SALES_SALESREASON_STREAM') OR
    SYSTEM$STREAM_HAS_DATA('SALES_SALESORDERDETAIL_STREAM') OR
    SYSTEM$STREAM_HAS_DATA('SALES_SALESTERRITORY_STREAM') OR
    SYSTEM$STREAM_HAS_DATA('PURCHASING_SHIPMETHOD_STREAM') OR
    SYSTEM$STREAM_HAS_DATA('PURCHASING_VENDOR_STREAM') OR
    SYSTEM$STREAM_HAS_DATA('SALES_SPECIALOFFER_STREAM') OR
    SYSTEM$STREAM_HAS_DATA('SALES_CUSTOMER_STREAM') OR
    SYSTEM$STREAM_HAS_DATA('SALES_STORE_STREAM') OR
    SYSTEM$STREAM_HAS_DATA('SALES_SPECIALOFFERPRODUCT_STREAM')
    AS
    BEGIN
