...
CREATE OR REPLACE TASK transform_data_task
    ...
    WHEN
        SYSTEM$STREAM_HAS_DATA('HUMANRESOURCES_DEPARTMENT_STREAM') OR
        SYSTEM$STREAM_HAS_DATA('HUMANRESOURCES_EMPLOYEE_STREAM') OR
        ...
        SYSTEM$STREAM_HAS_DATA('PRODUCT_CATEGORY_STREAM') OR
        SYSTEM$STREAM_HAS_DATA('PRODUCT_INVENTORY_STREAM') OR
        ...
        SYSTEM$STREAM_HAS_DATA('PRODUCT_SUBCATEGORY_STREAM') OR
