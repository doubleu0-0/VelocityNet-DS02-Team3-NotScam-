...
DECLARE
    ...
    c1 CURSOR FOR
        ...
        WHERE table_schema = 'TEAM3_SCHEMA'
          ...
          AND table_name IN ('HUMANRESOURCES_DEPARTMENT','HUMANRESOURCES_EMPLOYEE','PERSON_ADDRESS',
          'PERSON_STATEPROVINCE','PRODUCTION_PRODUCT','PRODUCT_CATEGORY','PRODUCT_INVENTORY',
          ...
          'SALES_SALESTERRITORY','PRODUCT_SUBCATEGORY','PURCHASING_SHIPMETHOD','PURCHASING_VENDOR',
